    ...
    >
      ...
      <div class="flex justify-center gap-2 mt-5">
        <input
          ...
          type="text"
          maxlength="1"
          class="md:px-3 md:py-2 text-center border border-gray-300 rounded w-8 md:w-16 focus:outline-none focus:ring-1 focus:ring-indigo-500"
          @input="handleInput(index)"
          :ref="`otpBox${index}`"
        />
      </div>
      ...
      <button
        class="md:w-full w-full md:px-3 py-2 mt-6 font-bold text-white rounded-md bg-primary-100 hover:bg-primary-100 focus:outline-none focus:ring-1 focus:bg-primary-100"
        @click="submitForm"
      >
        Continue
      </button>
