<template>
  <header
    class="flex justify-center w-full px-4 py-2 border-b lg:py-5 lg:px-6 bg-primary-700 border-neutral-200"
  >
    <div
    ...
    >
      ...
      <SfButton
        ...
        class="order-first mr-4 text-white hover:text-white active:text-white hover:bg-primary-800 active:bg-primary-900 lg:hidden lg:order-1"
        square
        variant="tertiary"
      >
        <SfIconMenu />
      ...
      <SfButton
        class="hidden text-white lg:flex hover:text-white active:text-white hover:bg-primary-800 active:bg-primary-900 lg:mr-4"
        variant="tertiary"
      >
        <template #suffix>
      ...
      <nav class="flex justify-end flex-1 lg:order-last lg:ml-4">
