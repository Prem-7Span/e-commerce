<template>
  <div class="flex flex-col mb-5 space-y-4">
    ...
    <div class="relative border rounded-md">
      <input type="text" id="firstName" v-model="userDetails.firstName" @input="validateField('firstName')"
    ...
    <div class="relative border rounded-md">
      <input type="text" id="lastName" v-model="userDetails.lastName" @input="validateField('lastName')"
        class="border-gray-300 pl-3 py-2 focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 text-gray-900 block px-2.5 pb-2.5 pt-4 w-full text-sm rounded-lg border-1 appearance-none focus:ring-0 peer"
        placeholder=" " />
      <label for="lastName"
    ...
    <div class="relative border rounded-md">
      <input type="tel" id="mobileNumber" maxlength="10" v-model="userDetails.mobileNo"
    ...
    <div class="relative border rounded-md">
      <input type="text" id="addressLine1" v-model="newAddress.addressLine1" @input="validateField('addressLine1')"
        class="border-gray-300 pl-3 py-2 focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 text-gray-900 block px-2.5 pb-2.5 pt-4 w-full text-sm rounded-lg border-1 appearance-none focus:ring-0 peer"
        placeholder=" " />
    ...
    <div class="relative border rounded-md">
      <input type="text" id="addressLine2" v-model="newAddress.addressLine2" @input="validateField('addressLine2')"
        class="border-gray-300 pl-3 py-2 focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 text-gray-900 block px-2.5 pb-2.5 pt-4 w-full text-sm rounded-lg border-1 appearance-none focus:ring-0 peer"
        placeholder=" " />
    ...
    <div class="relative border rounded-md">
      <select id="country" v-model="newAddress.countryId" @change="validateField('countryId')"
        class="border-gray-300 pl-3 py-2 focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 text-gray-900 block px-2.5 pb-2.5 pt-4 w-full text-sm rounded-lg border-1 appearance-none focus:ring-0 peer">
        <option selected disabled>Choose a country</option>
        <option v-for="(country, i) in allCountries" :key="i" :value="country.id" class="text-primary-300">
          {{ country.countryName }}
        </option>
      </select>
      <label for="country"
    ...
    <div class="relative border rounded-md">
      <select id="states" v-model="newAddress.stateId" @change="() => {
    validateField('stateId')
    fetchCity(newAddress.stateId)
  }" class="border-gray-300 pl-3 py-2 focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 text-gray-900 block px-2.5 pb-2.5 pt-4 w-full text-sm rounded-lg border-1 appearance-none focus:ring-0 peer">
        <option selected disabled>Choose a state</option>
        <option v-for="(state, i) in allStates" :key="i" :value="state.id" class="text-primary-300">
          {{ state.stateName }}
        </option>
      </select>
      <label for="states"
    ...
    <div class="relative border rounded-md">
      <select id="cities" v-model="newAddress.cityId"  @change="validateField('cityId')"
        class="border-gray-300 pl-3 py-2 focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 text-gray-900 block px-2.5 pb-2.5 pt-4 w-full text-sm rounded-lg border-1 appearance-none focus:ring-0 peer">
        <option selected disabled>Choose a city</option>
        <option v-for="(city, i) in allCities" :key="i" :value="city.id" class="text-primary-300">
          {{ city.cityName }}
        </option>
      </select>
      <label for="cities"
    ...
    <div class="relative border rounded-md">
      <input type="text" id="pincode" v-model="newAddress.pincode" @input="validateField('pincode')"
        class="border-gray-300 pl-3 py-2 focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 text-gray-900 block px-2.5 pb-2.5 pt-4 w-full text-sm rounded-lg border-1 appearance-none focus:ring-0 peer"
        placeholder=" " />
      <label for="pincode"
...
export default {
  ...
  setup(props, { emit }) {
    ...
    const updateAddress = async () => {
      try {
        await axios.put(`https://api.8orbit.shop/api/v1/address/${props.addressToEdit.id}`, newAddress.value, {
          headers: {
