  <template>
    <div class="text-primary-300 px-2 md:px-6 scrollbar-hide ">
      ...
      <hr class="p-1 px-20" />
      <input type="checkbox" id="Casual" v-model="selectedCategories" value="Casual" @change="updateSelectedCategories" />
      <label for="Casual"> Casual</label><br />
      <input type="checkbox" id="Sports" v-model="selectedCategories" value="Sports" @change="updateSelectedCategories" />
...
<div class="h-screen overflow-auto">
  ...
  export default {
    ...
    computed: {
      filteredProducts() {
        return this.productStore.filterProducts(this.selectedCategories);
      },
    },
  };
  </script>
